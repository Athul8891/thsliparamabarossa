      ...
      endDrawer: Drawer(
        child: ListView(
          ...
          children: ListTile.divideTiles(context: context, tiles: [
            ...
            _createDrawerItem(icon: Icons.info, text: 'About', onTap: null),
            ExpansionTile(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Shop by Category",
                      style: TextStyle(
                          color: Color(0xFF484848), fontFamily: 'Gilroy'),
                    ),
                  ),
                ],
              ),
              children: [
                ...
                _createDrawerItem(
                    icon: Icons.home,
                    text: 'Daily Contact Lenses',
                    onTap: null),
                _createDrawerItem(
                    icon: Icons.home, text: 'Solutions', onTap: null),
              ],
              trailing: Icon(Icons.keyboard_arrow_down),
            ),
            _createDrawerItem(icon: Icons.call, text: 'Contact', onTap: null),
          ]).toList(),
        ),
      ),
      appBar: AppBar(
...
//                padding: const EdgeInsets.all(8.0), child: Text('YourAppTitle'))
      ...
      body: Container(
          ...
          child: Container(
            ...
            child: ListView(
              children: <Widget>[banner(), _tabSection(context), gridList()],
            ),
          )),
    );
  }
  ...
  Widget banner() {
    return Container(
      ...
      child: Carousel(
        images:
            arrImages.length != 0 ? arrImages : [AssetImage("images/logo.png")],
        dotSize: 4.0,
        dotSpacing: 15.0,
